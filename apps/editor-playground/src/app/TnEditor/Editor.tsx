...
import './index.less';
import { onCommandI, onTabDown, onCommandB, onCtrlA, onCommandU, onCommandShiftX } from './plugins/default';
...
export const TnEditor = ({
  ...
  const editor = useMemo(() => {
    ...
    editor.pluginManager = new PluginManager({
      elementPlugins,
      eventPlugins: [onTabDown, onCtrlA, onCommandB, onCommandI, onCommandU, onCommandShiftX],
    });
    return editor;
  }, []);
