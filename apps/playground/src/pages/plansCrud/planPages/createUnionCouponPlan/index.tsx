...
import { UnionCouponPlanFormProps, UnionCouponPlanFormState } from './interface'
 ...
 *
 */
export const CrudUnionCouponPlan = observer(() => {
  ...
  return (
    <BaseContainer loading={isLoading} error={isError} errorMsg={errorMsg}>
      <EasyPage<UnionCouponPlanFormState, UnionCouponPlanFormProps>
        pageType="form"
        commonUIConfig={{
          form: {
            labelCol: { span: 3 },
        ...
        context={{
          maxExpandLevelMcc: mccKeys.amount_limit_4_out_site_max_threshold,
