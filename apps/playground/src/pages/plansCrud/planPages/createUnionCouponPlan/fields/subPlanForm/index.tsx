...
import {
  UnionCouponSubPlanFormState,
  UnionCouponSubPlanFormProps,
} from './interface'
import { unionCouponSubPlanInfo } from './pageInfo'
import { getEditableConfig } from './utils'
import { useEffect, useState } from 'react'

export const UnionCouponSubsidyForm: SubPlanFormComponent = ({
  curForm,
  curIdx,
  onChildFormChanged,
  setChildFormRef,
  ...
  return (
    <EasyPage<UnionCouponSubPlanFormState, UnionCouponSubPlanFormProps>
      pageType="form"
      commonUIConfig={{
        form: {
          labelCol: { span: 3 },
      ...
      context={
        {
          ...
          ...childFormContextData,
          editable: editConfig,
        } as UnionCouponSubPlanFormProps
      }
      {...unionCouponSubPlanInfo}
    />
  )
}
