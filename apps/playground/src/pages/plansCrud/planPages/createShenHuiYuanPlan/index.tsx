...
import { ShenHuiYuanPlanFormProps, ShenHuiYuanPlanFormState } from './interface'
...
export const CrudShenHuiYuanPlan = observer(() => {
  ...
  return (
    <BaseContainer loading={isLoading} error={isError} errorMsg={errorMsg}>
      <EasyPage<ShenHuiYuanPlanFormState, ShenHuiYuanPlanFormProps>
        pageType="form"
        commonUIConfig={{
          form: {
            labelCol: { span: 3 },
